/**
* \file    SpecialModeData_type.cpp
* \brief     Declaration of SpecialModeData_type
*
* \details
...
*/
#ifndef APPS_SPECAILMODEDATA_TYPE_H_
#define APPS_SPECAILMODEDATA_TYPE_H_
...
#endif //APPS_SPECIALMODEDATA_TYPE_H_
